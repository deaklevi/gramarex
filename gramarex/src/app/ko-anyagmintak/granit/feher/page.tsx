...
export default function FehérGranitPage() {
  return (
    <div className="min-h-screen bg-[#FDFBF7] pt-28 pb-16 px-6">
      <div className="max-w-7xl mx-auto flex flex-col items-center">
        
        <div className="w-full max-w-[1500px]">
          <h1 className="text-2xl font-semibold mb-6 text-stone-900">Fehér gránit</h1>
          
          <TitleCard 
            imageSrc="/ko-anyagmintak/granit/feher.jpg" 
